  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseorder" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('new_order')}}">New Orders</a>
            <a class="collapse-item" href="{{route('all_order')}}">All Orders</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('addemployee')}}">Add Employee</a>
            <a class="collapse-item" href="{{route('allemployee')}}">All Eomployee</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('allcustomer')}}">All Customer</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('addsupplier')}}">Add Supplier</a>
            <a class="collapse-item" href="{{route('allsupplier')}}">All Suppliers</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsesalary" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('all_advance_salary')}}">All Advance Salary</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsecategory" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
      ...
      <li class="nav-item">
        ...
        <div id="collapseproduct" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">category</h6>
      ...
      <li class="nav-item">
        ...
        <div id="collapseexpense" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('add_expense')}}">Add New</a>
            <a class="collapse-item" href="{{route('all_expense')}}">All Expense </a>
            <a class="collapse-item" href="{{route('this_month_expense')}}">Monthly Expense </a>
            <a class="collapse-item" href="{{route('yearly_expense')}}">Yearly Expense </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseattendense" aria-expanded="true"
          aria-controls="collapseattendense">
          <i class="fa fa-address-book" aria-hidden="true"></i>

          <span>Attendense(Emp)</span>
        </a>
        <div id="collapseattendense" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">expense</h6>
            <a class="collapse-item" href="{{route('take_attendense')}}">Take Attendense</a>
            <a class="collapse-item" href="{{route('all_attendense')}}">All Attendense </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('edit_setting')}}">
