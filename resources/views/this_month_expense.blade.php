        ...
        <div class="col  mb-4">
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ $month_e }},{{$year_e}} Expense list</h6>
                    <h4 class="m-0 font-weight-bold text-danger">This month Total Expense : {{ $amount }}</h4>
                ...
                <form action="{{ url('/monthly_expense') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        @error('month')
                        ...
                        <select name="month" id="exampleInputEmail1" aria-describedby="emailHelp">
