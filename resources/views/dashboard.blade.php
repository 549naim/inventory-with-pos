              ...
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card h-100">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-uppercase mb-1"> Order Completed</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{$complete_order}}</div>
                        <div class="mt-2 mb-0 text-muted text-xs">
              ...
              <div class="col-xl-8 col-lg-7 mb-4">
                <div class="card">
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <a class="m-0 float-right btn btn-danger btn-sm" href="{{url('/new_order')}}">View More <i
                        class="fas fa-chevron-right"></i></a>
                  </div>
                  <div class="table-responsive">
                    <table class="table align-items-center table-flush">
                      <thead class="thead-light">
                        ...
                        <tbody>
                        <tr>
                          <td><a >RA{{$data->id}}</a></td>
                          <td>{{$data->cus->name}}</td>
                          <td>Nasi Padang</td>
                          <td><span class="badge badge-danger">{{$data->order_status}}</span></td>
